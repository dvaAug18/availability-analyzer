...
public class RegexpLogRowParserTest {

    LogRowParser parser = new RegexpLogRowParser();

    @Test
    @DisplayName("RegexpLogRowParser успешный разбор")
    ...
    @Test
    @DisplayName("RegexpLogRowParser ошибка при разборе даты")
    ...
    @Test
    @DisplayName("RegexpLogRowParser ошибка при разборе http статуса")
    ...
    @Test
    @DisplayName("RegexpLogRowParser ошибка при разборе длительности запроса")
